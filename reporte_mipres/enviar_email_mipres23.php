...
################################################################################
################################################################################
#################      ARMADO PRESCRIPCIONES AÃ‘O 2023      #####################


        $consulta_direccionamiento = $reporte->get_direccionamientos('2023-01-01', '2023-12-31');
        ...
        $archivo_direccionamientos = ($data_direccionamientos) ? generar_arc_direccionamientos22($reporte->get_data_direccionamientos('2023-01-01', '2023-12-31')) : '0';

################################################################################
################################################################################
################################################################################
#############    ARMADO PRESCRIPCIONES AÃ‘O 2023 CON URG Y HOSP    ##############


        $consulta_direUH = $reporte->get_direUH('2023-01-01', '2023-12-31');
        $data_direUH = array();
        $sum_reg_dirUH = 0;
        ...
        $archivo_direccionamientosUH = ($data_direUH) ? generar_arc_direUH22($reporte->get_data_direUH('2023-01-01', '2023-12-31')) : '0';
...
###################  COMPRUEBO SI HAY DATOS PARA ENVIAR   ######################
		...
		$mail->addAddress(COR_RECOBROS);                              
                ...
                $tabla_msg = "<p style='text-align: justify'> "
                        . "Consolidado registros MIPRES de la vigencia 2023 con fecha m&aacute;xima de entrega menor a la actual y sin "
                        . "reporte de entrega por parte del proveedor de servicios."
                        . "</p>"
                        . "<table border='1' cellspacing='0' cellpadding='2' style='width: 50%;'> "
                        . "<thead> "
                        . "<tr> "
                        . "<th colspan='4' style='background-color: #e1edd7'>Prescripciones Vigencia 2023 - (Se excluyen servicios con &aacute;mbito hospitalizaci&oacute;n y urgencias) </th> "
                        . "</tr> "
                        . " <tr> "
                        ...
                        . "<thead> "
                        . "<tr> "
                        . "<th colspan='4' style='background-color: #e1edd7'>Prescripciones Vigencia 2023 - Trazabilidad solo Urgencias y Hospitalizaci&oacute;n</th> "
                        . "</tr> "
                        . " <tr> "
                        . "<th style='background-color: #e1edd7'>Tip_ident.</th> "
                        . "<th style='background-color: #e1edd7'>Num_ident.</th> "
                ...
                $mail->Subject = utf8_decode("Notificacion Diaria - Registros MIPRES sin reporte de entrega vigencia 2023");
