...
class ReporteAutorizacion {
    ...
    public function get_autorizaciones_estado_NP() {
        ...
        $sql = "SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED "
                . "SELECT top 1 NO_SOLICITUD, NO_AUTORIZACION, FEC_AUTORIZA, FEC_VENCIMIENTO, COUNT(A.NO_SOLICITUD) AS TOTAL_REGISTROS "
                . "FROM AUTORIZACION A "
                . "WHERE ESTADO = 'NP' "
    ...
    public function get_aut_por_prestador_estado_NP($nit_prestador) {
        ...
        $sql = "SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED "
                . "SELECT NO_SOLICITUD, NO_AUTORIZACION, FEC_AUTORIZA, FEC_VENCIMIENTO, COUNT(A.NO_SOLICITUD) AS TOTAL_REGISTROS  "
                . "FROM AUTORIZACION A "
                . "INNER JOIN prestadores t2 on a.NR_IDENT_PREST_IPS  = t2.NIT_PRESTADOR "
                . "WHERE DATEADD(MONTH, 2,  CAST(FEC_VENCIMIENTO AS DATE)) = CAST(GETDATE() AS DATE) "
                . "AND a.NR_IDENT_PREST_IPS = '".$nit_prestador."' "
                . "GROUP BY  A.NO_SOLICITUD, NO_AUTORIZACION, FEC_AUTORIZA, FEC_VENCIMIENTO,FEC_AUTORIZACION "
                . "ORDER BY A.FEC_AUTORIZACION DESC ";
